package com.tenet.pia.calendarProvider;
...
import static com.tenet.pia.calendarProvider.Util.checkContextNull;
...
public class CalendarProviderManager {
    ...
    // ----------------------- 创建日历账户时账户名使用 ---------------------------
    private static String CALENDAR_NAME = "pia";
    private static String CALENDAR_ACCOUNT_NAME = "pia";
    private static String CALENDAR_DISPLAY_NAME = "pia的账户";
    ...
    public static int addCalendarEvent(Context context, CalendarEvent calendarEvent) {
        ...
        if (-2 != calendarEvent.getAdvanceTime()) {
            ...
            int i = calendarEvent.getAdvanceTime();
